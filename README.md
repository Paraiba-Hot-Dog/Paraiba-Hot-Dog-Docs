...
1. Criar feature branch: `git checkout -b feature/nome-da-feature`
2. Fazer commit das mudanças: `git commit -m "descrição clara"`
3. Fazer push: `git push origin feature/nome-da-feature`
...
- [x] Sistema de PDV para registro de pedidos
- [x] Dashboard BI com gráficos de vendas
- [x] Controle de estoque automático
- [x] Sistema de fidelidade para clientes
- [x] Deploy contínuo com GitHub Actions

## 📞 Suporte

Em caso de dúvidas, entre em contato com o líder do projeto (Samuel Ribeiro da Costa).

---

**Último atualização**: Março de 2026
